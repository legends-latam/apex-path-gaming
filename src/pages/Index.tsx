...
import heroImage from '@/assets/legends-dashboard.jpg';
import dashboardImage from '@/assets/background-landing.jpg';
      ...
      <nav className="relative z-10 flex justify-between items-center px-6 lg:px-12 py-6">
        <div className="flex items-center space-x-3">
          <div className="w-12 h-12 flex items-center justify-center">
            <img 
              src={logo} 
              alt="LEGENDS tu plataforma favorita para entrenar con proposito en los esports" 
              className=""
            />
          </div>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className={`transition-all duration-1000 delay-300 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            ...
            <img 
              ...
              />
              <div className="absolute top-2 left-2 glass-card p-3 rounded-lg border border-neon-purple/30">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                quote: "Por fin subi de mi rango de 1 año en 6 meses. El análisis IA es brutal y preciso.",
                country: "🇨🇴 Colombia"
              }
      ...
      <section className="relative z-10 px-6 lg:px-12 py-16">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-glow">
            ¿Porqué sigues en el mismo ranking despues de tantas partidas?
          </h2>
          ...
          <Card className="glass-card border-neon-cyan/30 glow-cyan p-8">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="space-y-4 text-left">
                <h3 className="text-xl font-bold text-glow mb-4">Tus Síntomas:</h3>
                {[
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="border-t border-neon-green/20 mt-8 pt-6 text-center">
            <div className="flex flex-col sm:flex-row justify-between items-center text-sm text-muted-foreground">
              <p>&copy; {new Date().getFullYear()} LEGENDS hecho por gamers para gamers. Todos los derechos reservados.</p>
            </div>
          </div>
        </div>
      </footer>
